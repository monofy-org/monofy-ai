...
from submodules.LivePortrait.src.live_portrait_pipeline import LivePortraitPipeline
from submodules.LivePortrait.src.utils.io import load_img_online
from submodules.LivePortrait.src.utils.rprint import rlog as log
from submodules.LivePortrait.src.utils.crop import prepare_paste_back, paste_back
from submodules.LivePortrait.src.utils.camera import get_rotation_matrix
...
class BasicPipeline(LivePortraitPipeline):
    ...
    def prepare_retargeting(self, input_image, flag_do_crop=True):
        ...
        if input_image is not None:
            ...
            raise Exception("The retargeting input hasn't been prepared yet!")
