...
class WebSightPlugin(PluginBase):
        ...
        def __init__(self):
            ...
            self.resources["tokenizer"] = AutoTokenizer.from_pretrained("your_model_directory")  # Load tokenizer from saved model
            self.resources["model"] = AutoModelForSequenceClassification.from_pretrained("your_model_directory")  # Load model from saved model
